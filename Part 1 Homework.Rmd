...
plot(sleeptable$TotalSleep,sleeptable$Predation,xlab = "Total Sleep",ylab="Predation")
abline(lm(sleeptable$TotalSleep~sleeptable$Predation))
```
```{r Total Sleep vs Exposure}
plot(sleeptable$TotalSleep,sleeptable$Exposure,xlab = "Total Sleep",ylab="Exposure")
abline(lm(sleeptable$TotalSleep~sleeptable$Exposure))
```
```{r Total Sleep vs Danger}
plot(sleeptable$TotalSleep,sleeptable$Danger,xlab = "Total Sleep",ylab="Danger")
